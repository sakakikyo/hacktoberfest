...
; 0000 007A // INT0: On
; 0000 007B // INT0 Mode: Low level
; 0000 007C // INT1: Off
; 0000 007D // INT2: On
; 0000 007E // INT2 Mode: Falling Edge
; 0000 007F GICR|=(0<<INT1) | (1<<INT0) | (1<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0x60)
	OUT  0x3B,R30
...
; 0000 0081 MCUCSR=(0<<ISC2);
	OUT  0x34,R30
; 0000 0082 GIFR=(0<<INTF1) | (1<<INTF0) | (1<<INTF2);
	LDI  R30,LOW(96)
	OUT  0x3A,R30
; 0000 0083 
...
_0x3:
; 0000 00A1       {
; 0000 00A2  PORTA=0b00001111;
	LDI  R30,LOW(15)
	RCALL SUBOPT_0x0
; 0000 00A3  delay_ms(1000);
; 0000 00A4  PORTA=0b11110000;
	LDI  R30,LOW(240)
	RCALL SUBOPT_0x0
